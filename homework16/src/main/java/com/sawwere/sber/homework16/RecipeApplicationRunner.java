package com.sawwere.sber.homework16;
...
import com.sawwere.sber.homework16.service.IngredientService;
import com.sawwere.sber.homework16.service.RecipeService;
import com.sawwere.sber.homework16.util.ConsoleUtils;
    ...
    private void resolveCreateRecipe() {
        ...
        try {
            ...
            if (ex.getCause() instanceof SQLException sqlException
                ...
                System.out.println("Среди введенных ингредиентов присутствует несуществующий в базе.\n" +
